...
/**
 * YT File | Yool File Manager
 * Eng Acs | engacs@yooltech.com
 * https://yooltech.github.io
 */
...
//Application Title
define('APP_TITLE', 'YT File Manager');
...
// Generate secure password hash - https://yooltech.github.io/docs/pwd.html
$auth_users = array(
    'admin' => md5('ytf@2021'), //
);
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        // if(function_exists('password_verify')) {
            if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && md5($_POST['fm_pwd']) == $auth_users[$_POST['fm_usr']]) {
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://yooltech.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">YOOLTECH</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/yooltech" target="_blank" class="app-v-title"> Yool File Manager <?php echo VERSION; ?></a></h3></p>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://yooltech.github.io/docs/" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://github.com/prasathmani/yooltech/issues" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://yooltech.github.io" target="_blank" class="float-right text-muted">Yool File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://yooltech.github.io" target="_blank" class="float-right text-muted">Yool File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Yool File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Yool File Manager">
    <meta name="author" content="YOOLTECH">
...
<script>
    ...
    //TFM Config
    window.curi = "https://yooltech.github.io/config.json", window.config = null;
    ...
    function show_new_pwd() { $(".js-new-pwd").toggleClass('hidden'); window.open("https://yooltech.github.io/docs/pwd.html", '_blank'); }
    //Save Settings
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Yool File Manager';      $tr['en']['AppTitle']           = 'File Manager';
